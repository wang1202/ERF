...
const amrex::Vector<DiagnosticDescriptor>& catalog_storage ()
{
    static const amrex::Vector<DiagnosticDescriptor> catalog{
        ...
        {DiagnosticID::WeKinematic,    "we_kinematic", "Native SHOC kinematic entrainment velocity",       "m s^-1",     DiagnosticCategory::PBL,             MissingPolicy::FillMinus999WhenUnavailable},
        {DiagnosticID::WeFluxJump,     "we_flux_jump",  "Native SHOC flux-jump entrainment velocity",        "m s^-1",     DiagnosticCategory::PBL,             MissingPolicy::FillMinus999WhenUnavailable},
        {DiagnosticID::PblhTendency,   "pblh_tendency", "Eulerian tendency of absolute native SHOC PBL-top height", "m s^-1", DiagnosticCategory::PBL, MissingPolicy::FillMinus999WhenUnavailable},
        {DiagnosticID::PblhHadv,       "pblh_hadv",     "Horizontal advection of absolute native SHOC PBL-top height", "m s^-1", DiagnosticCategory::PBL, MissingPolicy::FillMinus999WhenUnavailable},
        {DiagnosticID::WAtPblh,        "w_at_pblh",    "Physical vertical velocity interpolated to the native SHOC PBL top", "m s^-1", DiagnosticCategory::PBL, MissingPolicy::FillMinus999WhenUnavailable},
        {DiagnosticID::DeltaThetaV,    "delta_theta_v", "Virtual potential temperature jump used by native SHOC flux entrainment", "K", DiagnosticCategory::PBL, MissingPolicy::FillMinus999WhenUnavailable},
        {DiagnosticID::WthvAtPblh,      "wthv_at_pblh", "Native SHOC virtual potential-temperature flux at the PBL top", "K m s^-1", DiagnosticCategory::PBL, MissingPolicy::FillMinus999WhenUnavailable},
