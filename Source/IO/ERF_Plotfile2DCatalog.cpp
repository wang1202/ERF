...
const amrex::Vector<DiagnosticDescriptor>& catalog_storage ()
{
    static const amrex::Vector<DiagnosticDescriptor> catalog{
        ...
        {DiagnosticID::TSfc,           "t_sfc",        "Effective ERF surface temperature used by MOST and radiation", "K", DiagnosticCategory::SurfaceLayer, MissingPolicy::FillMinus999WhenUnavailable},
        ...
        {DiagnosticID::SurfaceTemperatureSource,
                                         "surface_temperature_source",
                                                        "Effective surface temperature source code (0=missing, 1=default, 2=WRF TSK, 3=SST, 4=Noah-MP, 5=OceanSurf)",
                                                        "1",         DiagnosticCategory::SurfaceLayer,    MissingPolicy::AlwaysAvailable},
        ...
        {DiagnosticID::LandSurfaceNoahmpSkinTemperature, "t_skin_noahmp", "Raw Noah-MP skin temperature", "K", DiagnosticCategory::LandSurface, MissingPolicy::FillMinus999WhenUnavailable},
